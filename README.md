tMoveMate — Your Personal Rehab AI ✨
🚀 Welcome to MoveMate!
...
Processing Selection Page (2_FeatureSelect.py)
...
Processing & Results Page (3_Processing.py)
...
🔗 Project Links
GitHub Repository: Jiraphat-code/Movemate-AI-Physical-Therapy-Coach

Medium Article: MoveMate: Your AI-Powered Rehab Companion at Home

Live Deployment (Streamlit Cloud): MoveMate AI Physical Therapy Coach
...
git clone https://github.com/Jiraphat-code/Movemate-AI-Physical-Therapy-Coach.git
...
Navigate and Interact within the App:
...
Project Link: https://github.com/Jiraphat-code/Movemate-AI-Physical-Therapy-Coach
